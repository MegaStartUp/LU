...
public class CsGlobals : MonoBehaviour
{
    ...
    public bool jump_button
    {
        ...
        set 
        {
            if (_jump_button != value)
                _jump_button=value;
        }

    }
    private bool _catch_button;
    public bool catch_button
    {
        get
        {
            return _catch_button;
        }
        set
        {
            if (_catch_button != value)
                _catch_button = value;
        }

    }
    private bool _skill_button;
